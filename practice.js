...
// Code Here
function first(){
  return promisedNames().then(function(result){ return result[0]; });
}
...
//Code Here
function last(){
  return promisedNames().then(function(result){ return result[result.length - 1]; });
}
...
//Code Here
promise6.then(function(result){ modifiedResolve = result * 2; })
